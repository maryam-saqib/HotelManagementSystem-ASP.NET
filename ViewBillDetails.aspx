        ...
        <div class="container" >
            <div class="row1">
                <div class="col-md-6 mx-auto">
                 ...
                 <div class="card2" id="panel1" runat="server" style="width:120%;justify-content:center; margin-left:-120px">
                    <div class="card-body" > 
                        <div class="row">
                            <div class="col" > 
                                <a style="margin-left:50px;margin-top:-16vh" href="Payments.aspx" class="arrow left"></a></div>
                                <center> 
                                 <br />
